...
```html {data-filename=app/components/important-text.hbs}
<div>
  <p class='important_generated-1 some-class'>Important text</p>
</div>
```

```css {data-filename=app/components/important-text.css}
  .important_generated-1{
    color: green;
  }
```
...
<div>
  <p class='important_generated-1 some-class' data-generated-1>Important text</p>
</div>
